...
const TrelloCardNotification: React.FC<TrelloCardNotificationProps> = ({ cardName, cardUrl }) => {
  ...
  return (
    <div
      className={cn(
        "fixed top-4 right-4 z-50 px-3 py-2 text-xs rounded-md shadow-lg",
        "bg-gray-100/80 backdrop-blur-sm text-black border border-gray-300/80",
    ...
    >
      ...
      <button
        ...
        className="p-1 rounded-full hover:bg-black/10 text-gray-700 hover:text-black flex-shrink-0"
